...
public class NotificationServiceTest {
    ...
    public void testNotificationWithLogNotificationChannel() {
        ...
        assertThat(logInterceptor.containsMessage("[Notification Service]  {id='" + NOTIFICATION_ID + "', aggregateType='Test', type='Test', additionalData={Key1=Value1}, timestamp=1684279500}"))
                .isTrue();
    }
